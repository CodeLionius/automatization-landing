...
const translations = {
  en: {
    ...
    calculatorPage: {
      ...
      autoDescription: 'Calculate the potential value and ROI of AI automation for your business processes.',
      roi: 'ROI Calculator',
      roiDescription: 'Calculate return on investment for your automation projects and business initiatives.',
  ...
  lt: {
    ...
    calculatorPage: {
      ...
      autoDescription: 'Apskaičiuokite DI automatizavimo potencialią vertę ir ROI jūsų verslo procesams.',
      roi: 'Investicijų pelningumo rodiklio (ROI) skaičiuoklė',
      roiDescription: 'Apskaičiuokite investicijų pelningumo rodiklį automatizavimo projektams ir verslo iniciatyvoms.',
